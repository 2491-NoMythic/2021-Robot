...
public class PositionButtonChecker extends SubsystemBase {
    ...
    public void periodic() {
        ...
        if (Constants.Controller.TM.useSliderHoodPosition) {
            double slider = driveController.getSliderAxis();

            slider = ((slider+1)/2);
            System.out.println(slider);
            
            Variables.Shooter.shooterHoodPosition = 70.0 + (slider * 66.0);
            Variables.Shooter.shooterSpeed = 6500.0 + (slider * 1800.0);
